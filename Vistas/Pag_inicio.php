...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#">DA File Manager</a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedConte aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <form class="form-inline my-2 my-lg-0" id="filters">
            ...
            <input class="form-control mr-sm-2" type="search" name="words" placeholder="Words" aria-label="Search">
    ...
    <!-- Modal -->
    <div class="modal fade" id="modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="t" >
        ...
        <!-- Add Todo-->
            ...
            <form>
                ...
                <div class="form-group d-inline-flex">
                    ...
                    <div class="mt-1 ml-2">
                    <input id="modal-completed" type="check" />
                    </div>
                </div>
            </form>
        </div>
        ...
        <form> 
            <div class="row">
                <div class="col-sm-3 d-sm-flex align-items-center">
                    ...
                    <input type="text" id="title" class="form-control ml-sm-2" placeholder="Learn JS">
                </div>
                <div class="px-sm-2 col-sm-7 d-sm-flex align-items-center mt-2 mt-sm-0">
                    <label class="m-sm-0">Description</label>
                    <input type="text" id="description" class="form-control ml-sm-2" placeholder="Watch JS Tutorials">
                </div>
                <div class="col-sm-2 d-sm-flex justify-content-end mt-4 mt-sm-0">
                    <button type="button" class="btn btn-info btn-block" id="add">Add</button>
                </div>
            </div>
        </form>
        </div>
  ...
  <!-- JS Code -->
  <script src="../JS/PagInicio.js" type="text/javascript" language="javascript"></script>
